                ...
                <?php 
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-sm btn-success" href="accept_request.php?rid=<?php echo $row['id']; ?>&bg=<?php echo $bg; ?>&nu=<?php echo $row['no_units']; ?>">Approve</a>
                            <a class="btn btn-sm btn-danger" href="reject_request.php?rid=<?php echo $row['id']; ?>">Reject</a></td>
                        </tr>
                        <?php
                        }
                        $sno++;
