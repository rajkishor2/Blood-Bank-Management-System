<?php 
    ...
    if(isset($_POST['update_patient'])){
        $query = "update patients set name = '$_POST[name]',email = '$_POST[email]',password = '$_POST[password]',mobile = $_POST[mobile] where id = $_GET[pid]";
    ...
    $query = "select * from patients where id = $_GET[pid]";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="submit" class="btn btn-danger" value="Update" name="update_patient">
            </form>
            </div>
        </div>
    </div>
