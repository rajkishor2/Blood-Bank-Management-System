<html>
    <body>
        <div class="row">
            ...
            <br><center><h4><u>Your Requests</u></h4><br></center>
            <table class="table">
                <thead>
                    <th>S.No</th>
                    <th>Request ID</th>
                ...
                <?php 
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ...
                        <tr>
                            ...
                            <td><?php if($row['status'] == 0){?> <a href="edit_request.php?pid=<?php echo $row['id']; ?>">Edit</a> | <a href="delete_request.php?pid=<?php echo $row['id']; ?>">Delete</a> <?php } ?></td>
                        </tr>
                        <?php
                        $sno++;
                    }
